...
###### BEGIN of part which reads the datafile and makes a list of lists with 3 floats of it
	...
	try:
		...
		#print daten3DListe[0]   ### just test output
		#print laenge/3    ### just test output
		#print testCoord[0]   ### just test output
	...
	for i in range(laenge):
		...
		###print newCoord ### just test output
		newCoordsList.append(newCoord)
	
	
	###print newCoordsList	### just test output
###### END of part which reads the datafile and makes a list of lists with 3 floats of it
